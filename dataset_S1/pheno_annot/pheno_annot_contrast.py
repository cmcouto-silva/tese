...
os.chdir('dataset_S1/pheno_annot')
...
# Load results
results = {mode: {
    method: pd.read_feather('../results_bin/{}/{}_contrast.feather'.format(mode, method)) for method in methods
    } for mode in modes }
...
with open('results_annot_contrast.pickle', 'wb') as file:
